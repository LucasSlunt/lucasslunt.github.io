...
function initializeTableVariables(){
    ...
    tApples.push(["Img","Gala","Sweet, tangy","Fairly crisp",5,"Best selling apple in North America","Golden Delicious x Kidds Orange Redd ","Jan 24, 2022",2]);
    tApples.push(["Img","Aurora Golden Gala","Very sweet","Crisp",9,"The skin feels slightly greasy","Gala x Splendour","Jan 25, 2022",3]);
    tApples.push(["Img","Jazz","Slightly sour","Crunchy",6,"Oblong shape","Braeburn x Gala","Jan 25, 2022",4]);
    tApples.push(["Img","Envy","Fairly sweet, inconsistent","Very dense, crisp",5,"Browns extremely slowly","Braeburn x Gala","Jan 26, 2022",5]);
    tApples.push(["Img","Fuji","Pleasant yet watery","Crisp",5,"Difficult to grow","Ralls Janet x Red Delicious","Jan 26, 2022",6]);
    tApples.push(["Img","Pink Lady (Cripps Pink)","Slightly sour","Softer",7,"Very popular in the UK","Golden Delicious x Lady Williams","Feb 2, 2022",7]);
    tApples.push(["Img","Spartan","Mildly sweet, vinous","Very soft",5,"Excellent for baking","McIntosh x ?","Feb 3, 2022",8]);
    tApples.push(["Img","Opal","Fairly sweet, floral","Crisp",7,"Browns slowly","Golden Delicious x Topaz","Feb 9, 2022",9]);
    tApples.push(["Img","Honeycrisp","Sweet, tart","Crunchy",8,"Bruises easily, hard to grow","Keepsake x MN1627","Feb 10, 2022",10]);
    tApples.push(["Img","Cosmic Crisp","Sweet, tart","Very crunchy",7,"Intended to replace Honeycrisp","Enterprise x Honeycrisp","Feb 11, 2022",11]);
    tApples.push(["Img","Granny Smith","Very Sour, citrusy","Crisp",4,"Excellent for baking","Unknown","Feb 14, 2022",12]);
    tApples.push(["Img","Ambrosia","Quite sweet, little flavour","Fairly crisp",5,"Sugar levels are measured with a brix refractometer before harvest","Golden Delicious x Red Delicious","Feb 16, 2022",13]);
    tApples.push(["Img","Red Delicious","Bland though fairly sweet","Muddy",2,"Not closely related to \'Golden Delicious\'","Unknown","Feb 22, 2022",14]);
    tApples.push(["Img","Rockit","Very sweet, slightly bitter","Crunchy",6,"Barely larger than a golf ball","Gala x Splendour","Mar 22, 2022",15]);
    tApples.push(["Img","SugarBee","Very Sweet, similar to Ambrosia","Crisp",6,"Long shelf life","HoneyCrisp x ?","Mar 22, 2022",16]);
    tApples.push(["Img","Orin","Sweet, pear","Crisp",9,"Tastes like a pear","Golden Delicious x Indo","Mar 24, 2022",17]);
    tApples.push(["Img","Kanzi","Sour, sweet","Crisp",8,"Quite similar to Honeycrisp","Braeburn x Gala","Mar 24, 2022",18]);
    ...
    tApples.push(["Img","Smitten","Fairly sweet, watery","Crisp",6,"Has 4 parents","Braeburn x Falstaff x Fiesta x Gala","Aug 2, 2022",21]);
    tApples.push(["Img","Unknown","Sour, citrusy","Very crisp",4,"From Place de la Gare park, Quebec city","Unknown","Aug 30, 2022",22]);
    tApples.push(["Img","Unknown","Sour, Fuji-like","Crisp",4,"From Place de la Gare park, Quebec city","Unknown","Aug 30, 2022",23]);
    tApples.push(["Img","Unknown","Tart, sweet","Softer",6,"From Hazeldell Orchard, Kelowna","Unknown","Sept 24, 2022",24]);
    tApples.push(["Img","Silken","Sweet, honey","Crisp",7,"Quite an ugly apple","Honeygold x Sunrise","Sept 24, 2022",25]);
    tApples.push(["Img","Nova Spy","Very sour, sweet","Crisp",6,"Trees are very hardy","Golden Delicious x Northern Spy","Oct 14, 2022",26]);
    tApples.push(["Img","Lucy Glo","Sweet, wild berries","Crisp",10,"Red fleshed apple","Hidden Rose x HoneyCrisp","Nov 27, 2022",27]);
    tApples.push(["Img","Lucy Rose","Sweet, slightly sour","Very crisp",5,"Red fleshed apple","Hidden Rose x Honeycrisp","Dec 29",28]);
    ...
    tApples.push(["Img","Sunrise","Sweet, sharp, juicy","Dense, crunchy",8,"Ripens very early, before Gala","Golden Delicious x McIntosh","Aug 3, 2023",31]);
    tApples.push(["Img","Transparent","Bland, sour","Very soft, muddy",1,"Very short shelf life (~10 days)","Unknown","Aug 4, 2023",32]);
    tApples.push(["Img","Unknown","Mildly bitter, slightly sour","Softer",3,"The best crabapples in Chapman Camp","Unknown","Aug 14, 2023",33]);
    tApples.push(["Img","Earligold","Sour, fairly sweet, concord grape","Very soft",8,"Incredible soft apple","Unknown","Aug 15, 2023",34]);
    tApples.push(["Img","Wynoochee Early","Tart, sweet, citrusy","Dense, crisp",6,"Good for cooking and cider","Unknown","Aug 18, 2023",35]);
    tApples.push(["Img","Unknown","Sour, bitter","Soft",2,"Found on along a walk in Kimberley","Unknown","Aug 27, 2023",36]);
    tApples.push(["Img","Jonaprince","Sour, slightly sweet","Crisp yet light",5,"Trees bear lots of fruit, with a long shelf life","Golden Delicious x Jonathan","Sept 17, 2023",37]);
    tApples.push(["Img","Ginger Gold","Sweet, barely tart, dry","Softer",7,"Named 'Ginger' after the farmer who discovered it, not the spice","Golden Delicious x ?","Oct 4, 2023",38]);
    tApples.push(["Img","McIntosh","Fairly sweet, slightly sour, vinous","Softer",8,"National apple of Canada","Unknown","Oct 13, 2023",39]);
    tApples.push(["Img","Golden Delicious","Sweet, barely sour","Softer",7,"Not closely related to Red Delicious","Grimes Golden x ?","Oct 18, 2023",40]);
    tApples.push(["Img","Hidden Rose","Tart, hints of strawberry lemonade","Crisp",7,"Red-fleshed apple","Unknown","Nov 9, 2023",41]);
    tApples.push(["Img","Salish","Sweet, tart","Crisp",6,"Named after a group of languages spoken by indigenous people of Canada","Gala x Splendour","Nov 11, 2023",42]);
    tApples.push(["Img","September Wonder (Fuji)","Pleasant, watery, slightly tart","Crisp",7,"A sport of Fuji","Fuji","Nov 12, 2023",43]);
    tApples.push(["Img","Pinata","Full, sweet, tart","Crisp",7,"Supposedly has a light pineapple aftertaste","Cox's Orange Pippin x Duchess of Oldenburg x Golden Delicious","Nov 15, 2023",44]);
    tApples.push(["Img","Unknown Jarred Apples","Cinnamon, spiced","Squishy yet firm, rubber",7,"Crabbapples of unknown variety preserved in a jar","Jan 5, 2024","Unknown",45]);
    tApples.push(["Img","Nicola","Sweet, barely tart","Dense, crisp",7,"Develops more flavour as the season progresses","Gala x Splendour","Jan 25, 2024",46]);
    tApples.push(["Img","Braeburn","Sweet, sour aftertaste","Softer",7,"A parent of many great apples","Red Delicious x Sturmer Pippin","Feb 25, 2024",47]);
    tApples.push(["Img","Alkmene (Red Windsor)","Sour","Very crisp, dense",5,"Given the Award of Garden Merit by Londons Royal Horticultural Society","Cox's Orange Pippin x Geheimrat Dr. Oldenburg","Sept 12, 2024",48]);
    tApples.push(["Img","Cox's Orange Pippin (Cox)","Very flavourful, sweet, tart","Crisp, dense",9,"Named after the farmer who grew it, \'Richard Cox\'","Unknown","Sept 23, 2024",49]);
    tApples.push(["Img","Bramley","Very sour","Crisp, hard",3,"Excellent for baking, very large","Gravenstein x ?","Sept 24, 2024",50]);
    tApples.push(["Img","Egremont Russet","Dry, pear-like, nutty, cinnamon, sweet","Crunchy",10,"Traditionally made into cider. The skin is rough like a russet potato","Unknown","Sept 25, 2024",51]);
    tApples.push(["Img","Pirouette","Sweet, a bit tart","Crisp",6,"Popular with organic growers","Clivia x Rubin","Sept 26, 2024",52]);
    tApples.push(["Img","Zari","Sweet, tangy","Crisp",5,"Fairly new variety, from belgium","Delbard Estivale x Elstar","Oct 2, 2024",53]);
    tApples.push(["Img","Santana","Sour, vinous","Crisp",6,"Specially developed to minimize the amount of a specific protein that some people are allergic to","Elstar x Priscilla","Oct 6, 2024",54]);
    tApples.push(["Img","Rubens (Civni)","Quite sweet, barely sour","Crisp, flakey like an asian pear",7,"All growers of the Rubens variety are required to use minimal pesticides.","Gala x Elstar","Oct 16, 2024",55]);
    tApples.push(["Img","Unknown","Fairly sweet, crabappley","Softer",7,"May have been related to Bramley, though it was much sweeter.","Unknown","Oct 19, 2024",56]);
    tApples.push(["Img","Maribelle","Mild","Firm",4,"Has a very large yield of apples","Elstar x Gloster x Meiprinses","Oct 22, 2024",57]);
    tApples.push(["Img","Reinette","Mild","Muddy",2,"\'Reinette\' is an umbrella term for ~50 different apples. It is unknown which specific reinette this apple is","Unknown","Nov 1, 2024",58]);
    tApples.push(["Img","Samboa","Incredibly sweet, dry","Very crisp",5,"\'Samboa\' is a brand name that cover 3 very similar apples, which only differ in their harvest times","Imperatriz x Pink Lady or Imperatriz x Baronesa","Nov 2, 2024",59]);
    tApples.push(["Img","Scarlett Paradise","Sweet, sour, similar to Aurora Golden Gala","Crisp",9,"Only available at select retailers in the UK","Unknown","Nov 3, 2024",60]);
    tApples.push(["Img","Pixie","Fairly sweet, sharp tang","Crisp",6,"Very small, barely larger than a mandarin orange","Unknown","Nov 4, 2024",61]);
    tApples.push(["Img","Delgoton","Mild, little flavour","Soft",3,"This variety may have been created through Delbard Orchards irradiating technique of \'regenesis\'","Unknown","Nov 5, 2024",62]);
    tApples.push(["Img","Red Dream","Sweet, very similar to Honeycrisp","Crisp",7,"Almost no information about this apple is online","Unknown","Nov 6, 2024",63]);
    tApples.push(["Img","Chantecler (Belchard)","Sweet, refreshingly sour","Soft, fine-grained",6,"Tastes similar to Golden delicious","Golden Delicious x Reinette Clochard","Nov 7, 2024",64]);
    tApples.push(["Img","Rubinette (Rafzubin)","Very sweet, sharp honey flavour","Crisp",7,"Quite small, difficult to grow","Cox's Orange Pippen x Golden Delicious","Nov 8, 2024",65]);
    tApples.push(["Img","Amber","Fairly sweet, soft, watery","Softer",5,"Not to be confused with \"Apple Amber\" an Irish dessert similar to an apple custard pie","Unknown","Nov 10, 2024",66]);
    tApples.push(["Img","Kissabel (Y101)","Sweet, tangy, vanilla, sweet berries","Between crisp and soft",9,"Kissabel is a trademark name for 6 similar apple varieties","Golden Delicious x SJ109","Nov 13, 2024",67]);
    tApples.push(["Img","CrimsonCrisp","Very sweet, sour","Very crisp, dense",8,"Can stay in storage for several months","PCF2-134 x PRI 669-205","Nov 15, 2024",68]);
    tApples.push(["Img","Magic Star (Sprank, Kentish Kiss)","Very sweet, slightly sour","Very crisp",6,"When grown organically, this apple is marketed under the name \'Natrya\'","Elise x ?","Nov 16, 2024",69]);
    tApples.push(["Img","Robijn","Mild, fairly sweet","Fairly soft",4,"This variety is a mutation of a mutation of Jonagold","Jonagold Delcosta","Nov 17, 2024",70]);
    tApples.push(["Img","Cheerfull Gold","Full, sweet, balanced sour taste","Crisp",8,"Apples hang onto the tree into winter","Cox's Orange Pippen x Golden Delicious","Nov 28, 2024",71]);
    tApples.push(["Img","Cameo","Fairly mild, just okay","Dense, crisp",4,"Its colour varies dramatically between apples","Golden Delicious x Red Delicious","Nov 28, 2024",72]);
    tApples.push(["Img","Lolipop (Inored)","Incredibly sweet, candy, dry","Very crisp",7,"Can stay in storage for up to 8 months","Pinova x X6398","Dec 21, 2024",73]);
    tApples.push(["Img","Red Prince (Red Jonaprince)","Mild","Soft",3,"Taste improves with age","Golden Delicious x Jonathan","Dec 23, 2024",74]);
    tApples.push(["Img","Golden Rose","Sour, fairly sweet","Crisp",6,"Very little information available online","Unknown","Dec 26, 2024",75]);
    tApples.push(["Img","Rave","Tart, sweet, ridiculously juicy","Very crisp",9,"One of the juiciest apples I have ever tried","Honeycrisp x MonArk","Dec 28, 2024",76]);
    tApples.push(["Img","Gravenstein","Complex, sweet, tart, toffee","Soft, mealy",6,"Popular heritage apple over 350 years old","Unknown","Dec 29, 2024",77]);
    tApples.push(["Img","Paula Red","Sweet, sour, floral, strawberry","Crisp, becomes soft later in the season",4,"The farmer who discovered it named it after his wife, Pauline","Duchess x McIntosh","Dec 30, 2024",78]);
    tApples.push(["Img","Empire","Sweet, vinous","Soft",6,"Has very thick skin","McIntosh x Red Delicious","Dec 31, 2024",79]);
    tApples.push(["Img","SweetTango (Minneiska)","Sweet, tangy, light","Very crunchy",7,"Long shelf life, though flavour degrades quickly with time","Honeycrisp x Zelstar!","Jan 1, 2025",80]);    
    tApples.push(["Img","Bliss","Sweet, slightly tart","Soft",4,"Little information available online.","Unknown","Jan 2, 2025",81]);
